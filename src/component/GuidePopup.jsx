...
import "@/public/scss/guide-modal.scss";
...
const CloseIcon = () => (
  <svg
    ...
    aria-hidden="true"
  >
    <circle cx="20" cy="20" r="20" fill="#97D80F" />
    <path
...
export default function GuidePopup({ open = false, onClose, closePopup }) {
  const [formSent, setFormSent] = useState(false);
  const handleClose = onClose || closePopup || (() => {});
  ...
  return (
    <div className="popup guide-modal">
      <div className="overlay" onClick={handleClose} aria-hidden="true" />
      <div className="guide-modal__wrap">
        <div className="popup-inner guide-popup">
          {!formSent ? (
            <GuideForm handleFormReset={() => setFormSent(true)} />
          ) : (
            <div className="form-sent">
              ...
              <p>
                Our team will review it shortly. Thank you for choosing Enlight.
              </p>
            </div>
          )}
        </div>
