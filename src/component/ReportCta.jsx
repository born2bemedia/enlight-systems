...
/**
 * CTA shown at the bottom of the report pages. Visually identical to
 * HomeCalculatorCta but a dedicated, report-only component with its own copy.
 */
function ReportCta() {
  return (
    <section className="home-calculator-cta report-cta">
      <div className="_container">
        <div className="home-calculator-cta__panel">
          <div className="home-calculator-cta__coins" aria-hidden="true">
            <div className="home-calculator-cta__coin home-calculator-cta__coin--btc">
              <img src="/images/home/calculator-cta/coin-btc.png" alt="" />
            </div>
            <div className="home-calculator-cta__coin home-calculator-cta__coin--alt">
              <img src="/images/home/calculator-cta/coin-alt.png" alt="" />
            </div>
            <div className="home-calculator-cta__coin home-calculator-cta__coin--triangle">
              <img src="/images/home/calculator-cta/coin-triangle.png" alt="" />
            </div>
            <div className="home-calculator-cta__coin home-calculator-cta__coin--eth">
              <img src="/images/home/calculator-cta/coin-eth.png" alt="" />
            </div>
          </div>

          <div className="home-calculator-cta__content">
            <div className="report-cta__head">
              <h2>Website issues are often symptoms of deeper marketing problems</h2>
              <p className="report-cta__text">
                Use Enlight to see where users are lost, where budgets are wasted,
                and where performance can be improved from one dashboard.
              </p>
            </div>
