...
const ContactForm = ({ handleFormReset, popupTitleContent = "", subtitle }) => (
  <div>
    <Formik
      initialValues={{
          ...
          <Form className="contact-form">
            ...
            <div className="form-block">
              ...
              <div className="input-wrap">
                <Field
                  name="problem"
                  className={touched.problem && errors.problem ? "invalid" : ""}
                />
            ...
            <div className="form-block">
              ...
              <div className="acceptance-wrap" onClick={() => {
                  setFieldValue('messanger', !values.messanger);
                }}>
                  <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect width="16" height="16" transform="translate(0.5)" fill="#2A2A2A" fill-opacity="0.1"/>
                    {values.messanger && <rect x="4.5" y="4" width="8" height="8" fill="#97D80F"/>}
                  </svg>
                  <span>Messenger <span>(Check this box if it is your messenger)</span></span>
                  <input
                    name="messanger"
                    type="checkbox"
            ...
            <div className="form-block">
              <label>Is there anybody we should send a copy of our reply to?</label>
              <div className="input-wrap">
                <Field
                  name="reply"
            ...
            <div className="form-block">
              ...
              <div className="input-wrap file-wrap">
                <span className="upload-custom" onClick={() => document.getElementById('file-upload').click()}>
                  Upload <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
  <path fill-rule="evenodd" clip-rule="evenodd" d="M12.5 2H6.5C5.70435 2 4.94129 2.31607 4.37868 2.87868C3.81607 3.44129 3.5 4.20435 3.5 5V19C3.5 19.7956 3.81607 20.5587 4.37868 21.1213C4.94129 21.6839 5.70435 22 6.5 22H18.5C19.2956 22 20.0587 21.6839 20.6213 21.1213C21.1839 20.5587 21.5 19.7956 21.5 19V11H15.5C14.7044 11 13.9413 10.6839 13.3787 10.1213C12.8161 9.55871 12.5 8.79565 12.5 8V2ZM21.5 9V8.828C21.4996 8.03276 21.1834 7.27023 20.621 6.708L16.793 2.878C16.2304 2.31572 15.4674 1.9999 14.672 2H14.5V8C14.5 8.26522 14.6054 8.51957 14.7929 8.70711C14.9804 8.89464 15.2348 9 15.5 9H21.5Z" fill="#0F0F0F"/>
</svg>
                </span>
                <span className="fileName">{values.file ? values.file.name : ''}</span>
                <input
                  id="file-upload"
                  name="file"
                  type="file"
