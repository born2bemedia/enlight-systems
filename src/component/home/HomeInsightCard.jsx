...
function HomeInsightCard({ title, slug, image }) {
  return (
    <article className="home-insights__card">
      <div className="home-insights__visual">
        <Image src={image} width={440} height={300} alt="" />
      </div>
