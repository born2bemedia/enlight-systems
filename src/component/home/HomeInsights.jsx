...
import { HOME_INSIGHTS } from "./homeInsightsData";
  ...
  return (
    <section className="home-insights">
      <div className="_container">
        <h2 className="home-insights__title">Featured insights</h2>

        <div className="home-insights__grid">
          {HOME_INSIGHTS.map((insight) => (
            <HomeInsightCard key={insight.id} {...insight} />
          ))}
        </div>

        <div className="home-insights__footer">
          <Link href="/resources" className="home-insights__more">
            <span>
              More insights
              <SendIconLight />
            </span>
