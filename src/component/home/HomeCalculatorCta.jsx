...
function HomeCalculatorCta({
  ...
  return (
    <section className={`home-calculator-cta ${className}`.trim()}>
      <div className="_container">
        <div className="home-calculator-cta__panel">
          ...
          <div className="home-calculator-cta__content">
            {(showBadge || lead) && (
              <div className="home-calculator-cta__intro">
                {showBadge && (
                  <p className="home-calculator-cta__badge">{badge}</p>
                )}
                {lead && <p className="home-calculator-cta__lead">{lead}</p>}
              </div>
            )}
