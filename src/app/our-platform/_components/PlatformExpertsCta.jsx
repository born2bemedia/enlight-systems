...
function PlatformExpertsCta() {
  return (
    <section className="platform-experts-cta">
      <div className="_container">
        <div className="platform-experts-cta__panel">
          <div className="platform-experts-cta__art" aria-hidden="true">
            <Image
          ...
          <div className="platform-experts-cta__content">
            <h2>Let our experts review your setup</h2>
            <p>
              Get a quick assessment of your marketing funnel, campaigns, and
              tracking setup to identify key performance gaps.
            </p>
...
export default PlatformExpertsCta;
