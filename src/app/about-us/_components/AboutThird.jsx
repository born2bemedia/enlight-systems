      ...
      <section className="about-third">
        <div className="_container">
          <div className="about-third__body">
            ...
            <RevealWrapper origin="bottom">
              <h3>
                Through our experience working with hundreds of crypto projects
                managed, we identified <br />
                the common pain points marketers face.
              </h3>
            </RevealWrapper>
            <RevealWrapper origin="bottom">
              <h4>
            ...
            >
              <div>
                <h4>01</h4>
                <p>
                  Difficulty in tracking campaign performance across multiple
                  platforms
                </p>
              </div>
              <div>
                <h4>02</h4>
                <p>Inefficient lead management and client communication</p>
              </div>
              <div>
                <h4>03</h4>
                <p>Limited insights into audience behaviour and preferences</p>
              </div>
            </RevealList>
            <RevealWrapper origin="bottom">
