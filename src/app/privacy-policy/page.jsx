          ...
          <div className="policy-content__body">
            <article>
              ...
              <p>
                ...
                three categories and the information collected in each case.
              </p>
              <h3>
              ...
              <ol>
                <li>
                  Information from browsers, devices, and servers: When you
                  visit our websites, we collect information that web browsers,
                  mobile devices, and servers provide, such as the internet
                  protocol (IP) address, browser type, language preference, time
                  zone, referring URL, date and time of access, operating
                  system, mobile device manufacturer, and mobile network
                  information. We include this information in our log files to
                  better understand website visitors.
                </li>
                <li>
              ...
              <ul>
                ...
                <li>
                  ...
                  visitor navigation to understand user preferences and improve
                  user experience.
                </li>
                <li>
                  Marketing Optimization: We monitor and enhance marketing
                  campaigns and provide relevant suggestions to users.
                </li>
              </ul>
              <h2>
                <strong>
              ...
              <p>
                ...
                on the personal information involved and the context in which we
                collect it.
              </p>
              <p>
              ...
              <p>
                ...
                information, or we may need your personal information to protect
              ...
              <p>
                ...
                you what those legitimate interests are when we collect your
                information.
              </p>
              <h2>
                <strong>Your choices regarding information use</strong>
              </h2>
              <h3>
                <strong>
              ...
              <p>
                You can unsubscribe from newsletters and other non-essential
              ...
              <p>
                ...
                de-identified information with third-party service providers we
                engage, such as marketing and advertising partners, web
                analytics providers, and payment processors. These service
                providers are authorised to use your personal information only
                as necessary to provide these services to us.
              </p>
              <h2>
                <strong>
                  Your rights regarding the information we hold about you as a
                  controller
                </strong>
              </h2>
              <p>
              ...
              <ul>
                <li>
                  ...
                  (and, if necessary, obtain a copy of) the categories of
                  personal information we hold about you. This includes
                  information about the source of the information, the purpose
                  and duration of processing, and the parties with whom the
                  information is shared.
                </li>
                <li>
                  <strong>Right to rectification</strong>: You can update or
                  correct any inaccuracies in the information we hold about you.
                  Depending on the purpose for which your data is used, you can
                  request that we add supplementary information about you to our
                  database.
                </li>
                <li>
                  <strong>Right to erasure</strong>: You have the right to
                  request the deletion of your personal information in certain
                  circumstances, such as when it is no longer necessary for the
                  purposes for which it was collected.
                </li>
                <li>
                  <strong>Right to restriction of processing</strong>: You may
                  also have the right to request that we limit the use of your
                  information in certain circumstances. For example, if you have
                  objected to our use of your data, we may need to verify
                  whether we have overriding legitimate grounds to continue
                  using it.
                </li>
                <li>
                  <strong>Right to data portability</strong>: You can receive
                  your information in a structured, commonly used, and
                  machine-readable format and transfer it to another party where
                  technically feasible. This right applies when your data is
                  processed based on your consent or automated means.
                </li>
                <li>
                  <strong>Right to object</strong>: You have the right to object
                  to using your information in certain circumstances, such as
                  when your personal information is used for direct marketing
                  purposes.
                </li>
                <li>
                  <strong>Right to complain</strong>: If you have any complaints
                  about how we collect, use, or share your information, you have
                  the right to complain with the appropriate supervisory
                  authority. However, this right may not be available to you if
                  there is no data protection supervisory authority in your
                  country.
                </li>
              </ul>
              <h2>
              ...
              <p>
                ...
                the purposes stated in this Privacy Policy. In some cases, we
                may retain your information for extended periods as permitted or
                required by law, such as to maintain suppression lists, prevent
                abuse, comply with legal obligations, or enforce our agreements.
                When we no longer have a legitimate need to process your
                information, we will delete or anonymize it from our active
                databases. We will securely store your information and isolate
                it from further processing on backup discs until deletion is
                possible.
              </p>
              <h2>
              ...
              <p>
                ...
                this Privacy Policy does not cover. If you submit your personal
                information to any of these third-party sites, their privacy
                policies govern your personal information. As a safety measure,
                we recommend that you do not share any personal information with
                these third parties unless you have checked their privacy
              ...
              <h2>
                <strong>Enforcement of our rights</strong>
              </h2>
              <p>
              ...
              <p>
                ...
                event that we sell our business or if we get acquired or merged,
                we will ensure that the acquiring entity is legally bound to
                honour our commitments to you. We will notify you via email or
                through a prominent notice on our website of any change in
                ownership or the use of your personal information and service
                data. We will also notify you about any choices you may have
                regarding your personal information and service data.
              </p>
              <h2>
