...
import { SPAM_CHECK_SOURCES } from "../resourcesData";
...
export function ResourcesCheckingModal({ open, onClose }) {
  if (!open) return null;
...
export function ResourcesSpamModal({ open, domain, onClose }) {
  if (!open) return null;
    ...
    <div className="popup resources-modal">
      ...
      <div className="popup-inner resources-modal__inner resources-modal__inner--spam">
        <div className="resources-spam-modal">
          ...
          <div className="resources-spam-modal__status">
            <ModalCheckIcon />
            <span>SAFE!</span>
          </div>
